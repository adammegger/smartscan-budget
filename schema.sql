...
CREATE POLICY "User can create own profile" ON "public"."profiles" FOR INSERT TO "authenticated" WITH CHECK (("auth"."uid"() = "id"));
...
CREATE POLICY "Użytkownicy mogą aktualizować swój profil" ON "public"."profiles" FOR UPDATE TO "authenticated" USING (("auth"."uid"() = "id"));



CREATE POLICY "Użytkownicy mogą widzieć swój własny profil" ON "public"."profiles" FOR SELECT TO "authenticated" USING (("auth"."uid"() = "id"));
